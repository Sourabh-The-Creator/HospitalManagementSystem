...
***/
        ...
        if (localStorage.getItem('name')) { //if data exist (todos are in storage)
            ...
            document.getElementById('doctor_name').innerHTML = localStorage.getItem('name'); //2
            document.getElementById('doctor_email').innerHTML = localStorage.getItem('email'); //2
            document.getElementById('doctor_id').innerHTML = localStorage.getItem('doctor_id'); //2
                        ...
                        <div>
                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="profile-usertitle">
                                    <div  class="profile-usertitle-name"><span id = "doctor_name">doctor_name</span></div>
                                    <div class="profile-usertitle-job"><b>Doctor</b></div>
                                </div>
                                <!-- END SIDEBAR USER TITLE -->
                                <div class="profile-usermenu">
                                    <ul class="nav">
                                    	<li ><a href="# "> <i class="glyphicon glyphicon-user "></i><span id="dept">dept</span></a></li>
                                        <li ><a href="# "> <i class="glyphicon glyphicon-envelope"></i> <span  id="doctor_email">doctor_email</span></a></li>
                                        <li ><a href="# "><i class="glyphicon glyphicon-tag"> </i> ID: <span id="doctor_id"> doctor_id </span></a></li>
