...
<body style="background-color: #dfdfdf9c;">
    ...
    <div id="content">
        <div id="h2">Add Outpatient</div>
        <div id="box">
            <img style="margin-left: 50px; margin-top: 10px;" src="../assets/img/Dashboard/bg.jpg" height="400px"
                width="680px">
            <form name="addOutpatient" action="/HMS/addOutpatient" onsubmit="return validateForm()" method="GET">
                <div class="text-block ">
                    ...
                    <div class="form ">
                        <label for="phone"><b>Amount.:</b></label>
